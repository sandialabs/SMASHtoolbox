...
switch obj.calibration.type
    ...
    case 'crystal'
        ...
        obj.calibration.cc = iterativeCCFilter(im, roi, threshFrac, regSize, ...
            'crystal');
...
function cc = iterativeCCFilterDetector(im, roi, thresh, regSize)
...
if strcmpi(type, 'crystal')
    initialThresh = thresh*lookup(im, roi(:,1), roi(:,2));
else
    initialThresh = thresh;
end
