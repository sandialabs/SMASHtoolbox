...
listCell = {'ignore', '13 µm', '13.5 µm', '25 µm', '26 µm', '43.48 µm', ...
    '86.957 µm','100 µm', '200 µm', 'custom', 'grid'};
convVec = [nan, 13e-6, 13.5e-6, 25e-6, 26e-6, 43.48e-6, 86.957e-6 100e-6, 200e-6, nan, nan]; % based on m
...
set(findobj(db.Figure, 'Tag', 'shape1'), 'Value', 1);
set(findobj(db.Figure, 'Tag', 'shape2'), 'Value', 0);
set(findobj(db.Figure, 'Tag', 'size1'), 'Value', ...
    num2str(obj.detector.size(1)));
set(findobj(db.Figure, 'Tag', 'size2'), 'Value', ...
    num2str(obj.detector.size(2)));
set(findobj(db.Figure, 'Tag', 'size2'), 'enable', 'on');
set(findobj(db.Figure, 'Tag', 'label1'), 'Text', 'Height');
set(findobj(db.Figure, 'Tag', 'label2'), 'Text', 'Width');
set(findobj(db.Figure, 'Tag', 'alphaSlide'), ...
    'Value', obj.detector.faceAlpha);
set(findobj(db.Figure, 'Tag', 'alphaEdit'), ...
    'Value', sprintf('%.2f',obj.detector.faceAlpha));
