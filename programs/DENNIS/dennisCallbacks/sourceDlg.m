...
setGap(cb, [0 10]);
newRow(cb);
h_radEditPolFracLabel = addMessage(cb, 11);
h_radEditPolFracLabel.Text = 'Fractional Polarization:';
h_radEditPolFrac = addEdit(cb,[0 3]);

setGap(cb, [0 0]);
newRow(cb);
h_radEditPolFrac1Label = addMessage(cb, 11);
h_radEditPolFrac1Label.Text = 'Polarization Direction:';
h_radEditPolComp = [addEdit(cb, 3) addEdit(cb, 3) addEdit(cb, 3)];
h_radEditPolComp(1).Text = 'x';
h_radEditPolComp(3).Text = 'y';
h_radEditPolComp(5).Text = 'z';
...
set(h_radEditPolFrac(2), 'Tag', 'PolFrac');
set(h_radEditPolComp(2), 'Tag', 'PolX');
set(h_radEditPolComp(4), 'Tag', 'PolY');
set(h_radEditPolComp(6), 'Tag', 'PolZ')
...
set(h_radEditPolFrac(2),'ValueChangedFcn', {@sourceFracEdit, mainFigure, h_radEditPolFrac});
set(h_radEditPolComp(2:2:6), 'ValueChangedFcn', {@sourceCompEdit, mainFigure, h_radEditPolComp});
...
function sourceFracEdit(src, event, mainFigure,h)
updateFromEdit(mainFigure, editExtract(h), 'source', 'polarizationFraction', ...
    h, true);
end

function sourceCompEdit(src, event, mainFigure,h)
updateFromEdit(mainFigure, editExtract(h), 'source', 'polarizationVector', ...
    h, true);
end
